...
ns.L = {
	...
	NEW_FLIGHT_PATH_DISCOVERED_HELP = "You have flight path location and/or flight times in your local database, which arent in the addon database yet, help to increase the known flight path locations/flight times and upload your data.",
	NEW_FLIGHT_PATH_DISCOVERED_HELP_2 = "This reminder only comes every 2 weeks, if you discovered new times, you can simply press ctrl+c to copy the url to the clipboard|n If you dont want to see this message you can turn it off in the config.",
	...
	WMC_QUEST_FLY = "Adds to the questtracker context menu, to allow to fly to the closest flight master for that quest",
	WMC_SET_QUEST_FLY = "Set flight to closest flight master",
	...
	FT_COLOR = "Flight Time Color",
	FT_COLOR_RECORDING = "Flight Time Color Recording",
	FT_BORDER = "Border",
	FT_TEXTURE = "Statusbar Texture",
	FT_BACKGROUND = "Frame Background",
	FT_FONT = "Font",
	FT_FONT_SIZE = "Font Size",
    FT_START_POINT = "Show start",
	FT_END_POINT = "Show Destination",
	FT_SHOW_TIME = "Show time",
	FT_SHOW_TIMER = "Show the timer frame",
	FT_TEXT_COLOR = "Text Color",
	FT_DEPLETE_BAR = "Deplete the timer bar",
	FT_REVERSE_BAR = "Reverse the filling direction",
	CONFIG_DONT_SHOW_UPLOAD = "Don't Show the 2 week upload reminder popup",
