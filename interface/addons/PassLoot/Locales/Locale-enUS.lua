...
local L = LibStub("AceLocale-3.0"):NewLocale("PassLoot", "enUS", true, debug);
...
local LM = LibStub("AceLocale-3.0"):NewLocale("PassLoot_Modules", "enUS", true, debug);
LM["Accessories"] = true
LM["Account"] = true
LM["Any"] = true
LM["Armor"] = true
...
LM["Can I Roll"] = true
LM["%class% - %spec%"] = true
LM["Challenge"] = PLAYER_DIFFICULTY5
LM["Class Spec"] = true
LM["Confirm BoP"] = true
LM["Confirm DE"] = true
LM["current"] = true
LM["Current Spec: %spec%"] = true
LM["Dungeon Finder"] = LOOKING_FOR_DUNGEON
LM["Equal to"] = true
...
LM["Legacy Raid - 10 Man"] = true
LM["Legacy Raid - 25 Man"] = true
LM["Less than"] = true
