...
L["Enabled"] = "활성화됨"
L["End Angle"] = "종료 각도"
L["Enter an aura name, partial aura name, or spell id"] = "오라 이름 / 오라 이름의 일부 / 주문 ID를 입력하세요"
L["Event"] = "이벤트"
L["Event Type"] = "이벤트 유형"
L["Event(s)"] = "이벤트"
L["Expand"] = "확장"
...
L["Group"] = "그룹"
L["Group (verb)"] = "그룹시키기"
L["Group aura count description"] = [=[디스플레이 조건을 충족하기 위해 주어진 오라에 영향을 받는 한명 이상의 %s원의 숫자.
정수를 입력하면 (예. 5), 영향을 받는 공격대원의 숫자를 입력된 숫자와 비교합니다.
소수 (예. 0.5), 분수 (예. 1/2), 또는 백분율 (예. 50%%)을 입력하면, %s 중 일부가 영향을 받아야 합니다.
...
L["Preset"] = "프리셋"
L["Prevents duration information from decreasing when an aura refreshes. May cause problems if used with multiple auras with different durations."] = "오라가 갱신 됐을 때 지속시간을 감소시키지 않습니다. 다른 지속시간을 가진 여러 오라를 사용할 때 문제가 발생할 수 있습니다."
...
L["to group's"] = "그룹 기준"
L["to Personal Ressource Display's"] = "개인 자원 표시의 다음 위치에"
L["to screen's"] = "화면 기준"
