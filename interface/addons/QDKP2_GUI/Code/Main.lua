...
function myClass.Refresh(self)
    ...
    if QDKP2_GuildData.AutoBossEarn then QDKP2frame1_UseBossMod:SetChecked(1)
    else QDKP2frame1_UseBossMod:SetChecked(0)
    end
    if QDKP2_GuildData.DetectBids then QDKP2frame1_DetectBids:SetChecked(1)
    else QDKP2frame1_DetectBids:SetChecked(0)
    end
    if QDKP2_GuildData.FixedPrices then QDKP2frame1_FixedPrice:SetChecked(1)
