...
--hooksecurefunc("ChatEdit_InsertLink",Toolbox.ShiftClickItem)  --disabled 1/28/2015 trying to track split stack bug  Made no difference in behavior
--appears that this was being handled in init, moved the hooksecure there.  Above 2 functions are never used.
