-- by 강남쌍칼(GangnamDualblade)
local L = Scrap_Locals
if GetLocale() ~= 'koKR' then return end

L["Add"] = "잡템으로 설정"
L["Added"] = "잡템으로 설정: %s"
L["AdvancedOptions"] = "고급 옵션"
...
L["Junk"] = "잡템"
L["Learn"] = "지능형 학습"
L["LearnTip"] = "활성화된 경우, 자주 상인에게 판매되는 아이템을 Scrap이 자동으로 잡템으로 인식할 수 있도록 학습합니다."
L["Loading"] = "로딩중..."
...
L["NotJunk"] = "예외 아이템"
L["Description"] = "이 옵션을 이용해 Scrap을 설정할 수 있습니다. 잡템은 잡템일 뿐!"
