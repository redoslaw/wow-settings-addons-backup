...
L["Use the same setting when entering a raid as the group leader?"] = "Willst du die gleichen Einstellungen wie der Gruppenanführer verwenden, wenn du einem Schlachtzug beitrittst?"
L["version"] = "Version"
L["Version"] = true
