...
L["You can use $gname tag in text. This will be replaced by your guild name."] = "Hier kannst du die Tags $gname und $glevel im Text der Bekanntmachung verwenden. Die Tags werden entsprechend durch den Namen der Gilde und den Level der Gilde ersetzt." -- Needs review
