...
L["You can use $gname tag in text. This will be replaced by your guild name."] = "Vous pouvez utiliser les expressions $gname et $glevel dans votre message. Elles seront remplacées respectivement par le nom de votre guilde et son niveau" -- Needs review
