...
L["STRING_SELLEPIC_DESC"] = [=[아이템 레벨이 600 이하인 귀속 에픽 장비를 판매합니다.

|cFFFFFF00중요:|r 접속을 종료하면 이 옵션은 기본값으로(비활성) 초기화됩니다.

 |cFFFFFF00중요:|r 실제로 사용하기 전에 중요한 아이템이 판매되는지 확인하기 위해 테스트를 해보세요.]=]
