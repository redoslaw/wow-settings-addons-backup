...
L["WQGF_KICK_TOOLTIP"] = "Auto-kick all players that are too far away"
L["WQGF_LEADERS_BL_CLEARED"] = "The leaders blacklist has been cleared."
L["WQGF_LEAVE"] = "Leave"
L["WQGF_MEMBER_TOO_FAR_AWAY"] = "The group member %s is %s yards away. Hit the auto-kick button to remove him from the party."
