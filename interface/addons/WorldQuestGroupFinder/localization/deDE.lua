...
L["WQGF_DEBUG_CURRENT_WQ_ID"] = "Momentane Weltquest-ID ist |c00bfffff%s|c00ffffff."
...
L["WQGF_INIT_MSG"] = "Klicke mit der mittleren Maustaste auf eine Weltquest in der Zielverfolgung, um nach einer Gruppe zu suchen."
L["WQGF_JOINED_WQ_GROUP"] = "Du bist der Gruppe von |c00bfffff%s|c00ffffff für |c00bfffff%s|c00ffffff beigetreten. Viel Spaß!"
L["WQGF_KICK_TOOLTIP"] = "Alle Spieler aus der Gruppe entfernen, die zu weit entfernt sind"
L["WQGF_LEADERS_BL_CLEARED"] = "Die Ignorierliste für Anführer wurde geleert."
L["WQGF_LEAVE"] = "Verlassen"
L["WQGF_MEMBER_TOO_FAR_AWAY"] = "Das Gruppenmitglied %s ist %s m entfernt. Klicke den Auto-Kick-Button, um ihn aus der Gruppe zu entfernen."
