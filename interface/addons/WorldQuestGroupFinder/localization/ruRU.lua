...
L["WQGF_NEW_ENTRY_CREATED"] = "Новая группа была создана для выполнения локального задания |c00bfffff%s|c00ffffff в |c00bfffff%s|c00ffffff."
L["WQGF_NO"] = "Нет"
...
L["WQGF_WQ_GROUP_DESCRIPTION"] = "Выполняем локальное задание \"%s\" в %s. Создано автоматически аддоном World Quest Group Finder %s."
