...
L["WQGF_CONFIG_AUTOINVITE_EVERYONE_HOVER"] = "所有申請者會自動邀請進隊伍，達到5人上限。"
...
L["WQGF_LEAVE"] = "離開"
L["WQGF_NEW_ENTRY_CREATED"] = "一個新的隊伍搜尋器登陸已經建立。在 |c00bfffff%s|c00ffffff 的 |c00bfffff%s|c00ffffff"
L["WQGF_NO"] = "不要"
...
L["WQGF_WQ_GROUP_DESCRIPTION"] = "正在 %s 解世界任務：\"%s\"。 由WQGF自動建立。 %s"
