...
--Warnings/Questions
QDKP2_LOC_NotIntoAGuild="You are not in a Guild."
QDKP2_LOC_NotIntoARaid="You are not in a Raid."
QDKP2_LOC_NeedManagementMode="You need to start a session to be able to use that feature."
QDKP2_LOC_BetaWarning="You are running a beta version of QDKPV2.\nPlease submit any tickets on the forum\npage at www.quickdkp.com. Thank You"
...
QDKP2_LOC_NODKP_Alt="Alt character"
QDKP2_LOC_NODKP_Standby="Standby to raid"
QDKP2_LOC_NODKP_External="External to guild"
...
QDKP2_LOC_BidRemove = "Your bet has been removed manually."
QDKP2_LOC_BidInvalid = "Your bet became invalid and has been removed."
...
QDKP2_LOC_BidGiveLoot = "Are you sure to give\n $ITEM\nto "..QDKP2_COLOR_BLUE.."$NAME|r for "..QDKP2_COLOR_GREEN.."$AMOUNT|r DKP?"
