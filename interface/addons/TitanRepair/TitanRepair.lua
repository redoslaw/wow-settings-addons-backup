...
local info;
	...
	if _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"] == 2 then
		if _G["LIB_UIDROPDOWNMENU_MENU_VALUE"] == "Discount" then
			TitanPanelRightClickMenu_AddTitle(L["REPAIR_LOCALE"]["discount"], _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"]);
...
--			info.func = TitanRepair_ShowPercentage;
		...
		if _G["LIB_UIDROPDOWNMENU_MENU_VALUE"] == "AutoRepair" then
			TitanPanelRightClickMenu_AddTitle(L["REPAIR_LOCALE"]["AutoReplabel"], _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"]);
		...
		if _G["LIB_UIDROPDOWNMENU_MENU_VALUE"] == "GuildBank" then
			...
			TitanPanelRightClickMenu_AddTitle(L["TITAN_REPAIR_GBANK_TOTAL"].." "..totalGB, _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"]);
			TitanPanelRightClickMenu_AddTitle(L["TITAN_REPAIR_GBANK_WITHDRAW"].." "..withdrawGB, _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"]);
			info = {}
		...
		if _G["LIB_UIDROPDOWNMENU_MENU_VALUE"] == "TooltipOptions" then
			TitanPanelRightClickMenu_AddTitle(L["REPAIR_LOCALE"]["TooltipOptions"], _G["LIB_UIDROPDOWNMENU_MENU_LEVEL"]);
