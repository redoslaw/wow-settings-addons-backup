		...
		["Default"] = {
			["messages"] = {
				...
				["PRIV O GILDII"] = {
					["text"] = {
						"", -- [1]
						"Jezeli moge Cie o to prosic, przeslij prosze jakies krotkie info odnosnie swojej postaci oraz ew. doswiadczenia raidowego na naszego gildyjnego maila: gildia@wipeforged.com. Bardzo ulatwi nam to robote...", -- [2]
						"Raz dziennie oficerowie sie zbiera, rozpatruja i omawiaja zgloszenia, a nastepnie wysylaja odp.", -- [3]
						"", -- [4]
						"", -- [5]
					},
					["custom"] = {
